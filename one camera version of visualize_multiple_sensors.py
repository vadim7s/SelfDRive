...
4. Initiate a random rotation at spawning
5. Limit to freeway
6. Create short episodes to record car getting straight and end there
7. Save images and control inputs to disk
8. Filter/remove/not-save images when the car is stopped or turning at an itersection
