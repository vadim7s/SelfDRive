...
# Vadim's change 1 - remove non-hero mode
...
class World(object):
    ...
    def update_hud_info(self, clock):
        ...
        if self.hero_actor is not None:
            ...
            hero_last_control = self.hero_actor.get_control()
            ...
            hero_mode_text = [
                'Hero Last Tick Throttle: %14s' % round(hero_last_control.throttle,4),
                'Hero Last Tick Steer: %14s' % round(hero_last_control.steer,4),
